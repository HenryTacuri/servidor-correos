...
a persistence unit "correosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "correos/pom.xml":
...
artifact ("correos.war") is already built. You can build
