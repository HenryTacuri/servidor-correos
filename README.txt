...
a persistence unit "carros-crudPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "carros-crud/pom.xml":
...
artifact ("carros-crud.war") is already built. You can build
